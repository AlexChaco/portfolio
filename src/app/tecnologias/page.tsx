...
const technologiesData = {
  ...
  backend: [
    ...
    { name: "SQL/ PostgreSQL", icon: <Database className="h-5 w-5 text-accent" /> },
    { name: "Java / Spring", icon: <Boxes className="h-5 w-5 text-accent" /> },
    // { name: "GraphQL / REST", icon: <Boxes className="h-5 w-5 text-accent" /> },
    { name: "Firebase", icon: <Cloud className="h-5 w-5 text-accent" /> },
    { name: "C#", icon: <Cpu className="h-5 w-5 text-accent" /> },
  ...
  tools: [
    ...
    { name: "Figma", icon: <Figma className="h-5 w-5 text-accent" /> },
  ...
  return (
    <section className="full-screen pt-24">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 order">
          {/* Frontend Technologies */}
          <motion.div className="bg-card rounded-xl shadow-sm p-6 border" variants={itemVariants}>
